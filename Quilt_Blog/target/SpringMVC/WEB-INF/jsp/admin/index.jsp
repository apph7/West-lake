    ...
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    <a href="javascript:;">
                        <img id="myImage" src="" class="layui-nav-img">
                        <script type="text/javascript">
                            function getHeadPic() {
                                var Url;
                                $.ajax({
                                    type: "POST",
                                    url: '<%=request.getContextPath()%>/admin/user/getUserHeadPic',
                                    cache: false,
                                    async: false,
                                    dataType: "json",
                            ...
                            var url =getHeadPic();
                            url="http://localhost:8080/Quilt_war"+url;
                            console.log(url);
                            var imgElement = document.getElementById("myImage"); // 获取图片的 <img> 元素
                            imgElement.src = url; // 将获取到的图片地址赋值给 img 标签的 src 属性
                        </script>
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <hr>
                        <dd><a href="<%=request.getContextPath()%>/index">退出</a></dd>
                    </dl>
                </li>
                <!--这里-->
        ...
        <div class="layui-side layui-side-menu">
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu"
                    ...
                    <li data-name="component" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd data-name="carousel">
                                ...
                                <a lay-href="<%=request.getContextPath()%>/article">
                                    <i class="layui-icon layui-icon-list"></i>
                                    所有活动</a>
                            </dd>
                            <dd data-name="flow">

                                <a lay-href="<%=request.getContextPath()%>/edit_articles">
                    ...
                    <li data-name="component" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd data-name="carousel">
                                ...
                                <a lay-href="<%=request.getContextPath()%>/admin/photos/all">
                                    <i class="layui-icon layui-icon-list"></i>
                                    所有相册</a>
                            </dd>
                    ...
                    <li data-name="component" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd data-name="carousel">
                                ...
                                <a lay-href="<%=request.getContextPath()%>/comments">
                    ...
                    <li data-name="announcement" class="layui-nav-item">
                        <a lay-href="<%=request.getContextPath()%>/Announcement" lay-tips="公告" >
                            <i class="layui-icon layui-icon-file-b"></i>
                            <cite>公告管理</cite>
                        </a>
                        <dl class="layui-nav-child">
                            <dd data-name="carousel">
                                <a lay-href="<%=request.getContextPath()%>/Announcement">
                                    <i class="layui-icon layui-icon-list"></i>
                                    公告</a>
                            </dd>
                            <dd>
                                <a lay-href="<%=request.getContextPath()%>/show">
                                    <i class="layui-icon layui-icon-util"></i>
                                    公告管理</a>
                            </dd>
                        </dl>
