...
<div class="layui-fluid">
    <div class="layui-row layui-col-space15">
        ...
        <form action="edit_articles" class="layui-form" id="myForm" method="POST" enctype="multipart/form-data">
            <div class="layui-col-md8">
                <div align="center">
                    <div class="layui-form-item" style="width: 90%;">
                        <input type="text" name="activity_name" id="articleTitle" lay-verify="title"
                               autocomplete="off" placeholder="请输入标题" class="layui-input">
                        <input type="text" name="activity_location" lay-verify="title"
                               autocomplete="off"  placeholder="请输入举办地" class="layui-input">
                        <input type="text" name="activity_link"  lay-verify="title"
                               autocomplete="off"  placeholder="请输入活动链接" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
                    <div id="layout" style="width:100%;background: #f6f6f6;">
                        <div class="editormd" id="test-editormd" style="height: 800px">
                            <input type="text"  style="height: 800px" name="activity_content" id="category_content" lay-verify="title"
...
<%
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        String activity_link = request.getParameter("activity_link");
        // 数据库连接信息
        try {
            // 加载MySQL的JDBC驱动程序
            ...
            String sql = "INSERT INTO activity_information (activity_name, activity_time, activity_location, activity_content, video_replay_link,has_live,subscription_status,activity_heat_level) VALUES (?, ?, ?, ?, ?, 1, 0, 0)";
            ...
            pstmt.setString(3, activity_location);
            pstmt.setString(4, activity_content);
            pstmt.setString(5, activity_link);
