...
<nav id="nav" style="background-image:url(<%=request.getContextPath()%>${backgroundImage})">
    <div id="page-header">
        <span class="pull-left"><strong></h2><a href="<%=request.getContextPath()%>/guest">cheers の Blog</a></strong></span>
        ...
        <span class="pull-right menus">
                    ...
                    <a class="site-page" href="<%=request.getContextPath()%>/photos"><i class="menu-item-icon fa fa-fw fa-photo"></i>相册</a >
                    ...
                    <a class="site-page" href="<%=request.getContextPath()%>/about"> <i class="menu-item-icon fa fa-fw fa-user fa-fw"></i>关于</a>
        </span>
    </div>
    ...
    <div id="site-info">
        ...
        <div id="site-social-icons">
            <a class="social-icon" href="https://gitee.com"><i class="fa-github fa"></i></a>
            <a class="social-icon" href="https://weibo.com"><i class="fa-weibo fa"></i></a>
            <a class="social-icon" href="https://qzone.qq.com"><i class="fa-qq fa"></i></a>
          <!--  <a class="social-icon" href="/login"><i class="fa-facebook fa"></i></a>-->
            <a class="social-icon search" href="https://www.baidu.com"><i class="fa fa-search"></i></a>
        </div>
    </div>
</nav>
