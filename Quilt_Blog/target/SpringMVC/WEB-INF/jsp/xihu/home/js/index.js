...
favicon2.href = '/img/smallLogo.png';
...
garrow.addEventListener('click',function(){
    ...
    if(customCarousel.classList.contains('trunRight')){
        garrow.classList.remove('ri-corner-up-right-line')
        garrow.classList.add('ri-corner-down-left-line')
    }else{
        garrow.classList.remove('ri-corner-down-left-line')
        garrow.classList.add('ri-corner-up-right-line')
    }
