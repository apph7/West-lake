...
public class UserController {
     ...
     * 获取用户头像地址
     */
    @RequestMapping("/getUserHeadPic")
    @ResponseBody
    public Result getUserHeadPic(){
        System.out.println(userService.getUserHeadPic());

        String str=userService.getUserHeadPic();
        Result<String> result = new Result<String>(QuiltEnums.SUCCESS,str);
        return result;
