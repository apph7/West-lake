    ...
    var active = {
            ...
            layer.open({
                ...
                //    var tid = $(this).attr('data-index')
                   var tag = window["layui-layer-iframe" + index].callbackdata();
                    $.ajax({
                        type:"post",
                        url: '<%=request.getContextPath()%>/admin/article/tag/mod/'+tid,
                      //  url: '<%=request.getContextPath()%>/admin/article/tag/mod',
                        data: tag,
                        cache: false,
                        dataType: "json",
        ...
        insert: function () {
            ...
            if (tagName) {
                $.ajax({
                    type:"Post",
                    url: '<%=request.getContextPath()%>/admin/article/tag/add',
                    //url: '/tag/add'+tagName+fontSize+fontColor,
                    data: {
                        'tagName': tagName,
                        'fontSize': fontSize,
                        'fontColor': fontColor
