...
<div class="layui-fluid">
    <div class="layui-row layui-col-space15">
        ...
        <%
            try {
                // 准备查询SQL语句
                String sql = "SELECT COUNT(*) FROM activity_information ";
                PreparedStatement stmt = conn.prepareStatement(sql);
                ResultSet rs = stmt.executeQuery();
                int rowCount = 0;
                if (rs.next()) { // 检查结果集是否有数据
                    rowCount = rs.getInt(1); // 获取结果集中的第一列的值
                }
        %>
        <div class="layui-col-sm6 layui-col-md3">
            <div class="layui-card">
                ...
                <div class="layui-card-body layuiadmin-card-list">
                    <p class="layuiadmin-big-font"><%= rowCount %></p>
                    <p>
                ...
                <div class="layui-card-body layuiadmin-card-list">
                    <%
                        ...
                        if (rss.next()) { // 检查结果集是否有数据
                            commentCount = rss.getInt(1); // 获取结果集中的第一列的值
                        }
                    %>
        ...
        <div class="layui-col-sm8">
            <div class="layui-row layui-col-space15">
                <div class="layui-col-sm12">
                    <div class="layui-card">
                        <div class="layui-card-header">最新发布活动<i class="layui-icon layui-icon-file-b"
